    ...
    <div className={style.body}>
      ...
      <div className={style.center  }>
        <div className={style.form}>
          ...
          {isPassword
            ?
            <span className={style.blue}>{passwordMessage}</span>
            :
            <span className={style.red}>{passwordMessage}</span>
          }
        </div>
        <div className={style.form}>
          <span>비밀번호 확인</span>
          ...
          {isPasswordConfirm
            ?
            <span className={style.blue}>{passwordConfirmMessage}</span>
            :
            <span className={style.red}>{passwordConfirmMessage}</span>
          }
        </div>
        ...
        <div className={style.btndiv}>
          {isPassword && isPasswordConfirm
            ?
            <input type="button" value="확인" className={style.btn} onClick={changePassword} />
            :
            ...
            <div>
              <div className={style.keyboardset}>
                {Lone.map((word, index) => (
                  ...
                  >
                    <img src={word} alt="" onContextMenu={handleContextMenu} style={{ "webkittouchcallout": "none" }} />
                  </button>
                ))}
              </div>
              <div>
